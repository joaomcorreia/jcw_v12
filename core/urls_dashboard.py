...
urlpatterns = [
    ...
    path("users/", views.legacy_dashboard_users, name="dashboard_users"),
    ...
    path("main-site/pages/", views.legacy_dashboard_main_site_pages, name="main_site_pages"),
    path("main-site/pages/<int:page_id>/edit/", views.legacy_dashboard_main_site_edit_page, name="main_site_page_edit"),
